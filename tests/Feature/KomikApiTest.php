...
class KomikApiTest extends TestCase
{
    ...
    public function test_can_get_all_komik(): void
    {
        ...
        Komik::factory()->count(3)->create(['kategori_id' => $kategori->id]);
        ...
        $response->assertStatus(200)
                 ->assertJsonStructure([
                     'message',
                     'data' => [
                         '*' => ['id', 'judul', 'penulis', 'kategori_id', 'stok', 'status', 'file_pdf']
                     ]
                 ]);
    ...
    public function test_validation_fails_on_create_komik(): void
    {
        ...
        $response->assertStatus(422)
                 ->assertJsonValidationErrors(['judul', 'kategori_id', 'stok', 'penulis', 'tanggal_terbit']);
    }
    ...
    public function test_show_komik_returns_404(): void
    {
        ...
        $response->assertStatus(404)
                 ->assertJsonFragment(['message' => 'Komik not found']);
    }
    ...
    public function test_can_delete_komik(): void
    {
        ...
        $response->assertStatus(200)
                 ->assertJsonFragment(['message' => 'Komik deleted successfully']);
